...
def pr_menu_sort(bot, update, user_data):
    ...
    keyboard = InlineKeyboardMarkup([
        [ikb(user.GetButtons('Подписчики 🔼'), callback_data='inst_sorting_followers_up'),
         ikb(user.GetButtons('Подписчики 🔽'), callback_data='inst_sorting_followers_down')],
        [ikb(user.GetButtons('Сначала новые 🕓'), callback_data='inst_sorting_date_new'),
         ikb(user.GetButtons('Сначала старые 🕑'), callback_data='inst_sorting_date_old')],
